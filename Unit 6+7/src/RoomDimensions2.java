...
public class RoomDimensions2 {
    public static void main(String[] args) {
        ...
        while(inputNum!=7)
        {
            ...
            else if (inputNum == 6) //print max occupancy
            {
                System.out.println("Maximum Occupancy: " + d.getMaxOccupancy());
            }

            else if (inputNum == 7); //quit without saying anything
